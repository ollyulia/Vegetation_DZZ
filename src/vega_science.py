...
class VegaScience:
    ...
    def _format_url_avaliable_images(
        ...
        ```
        http://mau_lyash:MR4t6CsN@sci-vega.ru/fap/toproxy/export/local/smiswms/get_metadata.pl?db_pkg_mode=hrsat&layers=unisat&request=GetMetadata&BBOX=60.503652,31.478316,63.137372,36.927534&srs=epsg:4326&max_cloudiness=25&width=1024&height=1024&dt_from=2024-07-15&dt=2024-07-20&limit=150&satellites=LANDSAT 8&stations=&devices=&products=
        ```
